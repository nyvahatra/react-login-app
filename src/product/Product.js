  ...
  return (
    <div>
      <div className='bg-white rounded shadow p-4 text-center' id='all_content'>
            ...
            <table className='table table-striped table-bordered'>
                <thead>
                    <tr>
                        ...
                        { cookie.role_user == 'admin' || cookie.role_user == '3' ? <th id="col_action">Actions</th> : <></>}
                    </tr>
                </thead>
                <tbody>
                    {allProducts.map((item, index) => 
                        <tr key={index}>
                            ...
                            {
                                cookie.role_user == 'admin' || cookie.role_user == '3' ? 
                                <>
                                    <td>
        ...
        {
            cookie.role_user == '2' || cookie.role_user == '3' || cookie.role_user == 'admin' ? 
            <>
